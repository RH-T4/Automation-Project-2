describe('Issue create', () => {
  ...
  it('Assignment 2 TASK 1 create an issue and validate it successfully', () => {
  ...
  it('Assignment 2 TASK 2 should validate title is required field if missing', () => {

    const randomTitle = faker.word.noun();
    const randomDescription = faker.word.words(2);
